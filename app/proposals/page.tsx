              ...
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Portal>
                  <DropdownMenu.Content
                    className="z-50 flex flex-col overflow-hidden rounded-lg border border-zinc-300 bg-white p-2"
                    side="bottom"
                    align="start"
                  >
                    <DropdownMenu.Item className="rounded-sm p-2 text-zinc-900 hover:cursor-pointer hover:bg-zinc-100">
                      New Project...
                    </DropdownMenu.Item>
                    <DropdownMenu.Item className="rounded-sm p-2 text-zinc-900 hover:cursor-pointer hover:bg-zinc-100">
                      Open...
